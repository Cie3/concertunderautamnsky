...
[elsif exp=ウ]
	...
	[if exp="sf.実績２１：全てを知り尽くした男!==void"]
		[font color=&色：種２]
		21.全てを知り尽くした男…★全員参加・恋愛全成就・文化祭成功、の３条件を満たした[r]
	[else]
		[font color=&色：文字]
		21.全てを知り尽くした男…　全員参加・恋愛全成就・文化祭成功、の３条件を満たす[r]
	[endif]
