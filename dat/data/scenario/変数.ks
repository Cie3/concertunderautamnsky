...
function intHighScores() {
	sf.ハイスコア成績３ = (int)sf.ハイスコア成績３;
	sf.ハイスコア進捗３ = (int)sf.ハイスコア進捗３;
	sf.ハイスコア成績４ = (int)sf.ハイスコア成績４; 
	sf.ハイスコア進捗４ = (int)sf.ハイスコア進捗４;
	sf.ハイスコア成績５ = (int)sf.ハイスコア成績５; 
	sf.ハイスコア進捗５ = (int)sf.ハイスコア進捗５;
	sf.ハイスコア成績６ = (int)sf.ハイスコア成績６; 
	sf.ハイスコア進捗６ = (int)sf.ハイスコア進捗６;
	sf.ハイスコア成績７ = (int)sf.ハイスコア成績７; 
	sf.ハイスコア進捗７ = (int)sf.ハイスコア進捗７;
	sf.ハイスコア成績８ = (int)sf.ハイスコア成績８; 
	sf.ハイスコア進捗８ = (int)sf.ハイスコア進捗８;
	sf.ハイスコア成績９ = (int)sf.ハイスコア成績９; 
	sf.ハイスコア進捗９ = (int)sf.ハイスコア進捗９;
}
