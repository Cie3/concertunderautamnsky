...
*ミドリを選んだ理由
[足跡デバッグ 名前=ミドリを選んだ理由]
[jump target="*ミドリを選んだ理由2" cond="!足跡('ミドリを選んだ理由')|| 足跡('カケルは気づいた')"]
[eval exp="種がある = 1" cond="findSeed('ミドリを選んだ理由') >= 0"]
[カケルなにしてる]
[種分岐 ア=ミドリを選んだ理由 イ=何か他の話題は…… 体力=&シナリオ消費]
[if exp=イ][jump target="*ミドリを選んだ理由2"][endif]
*本文
[モノローグ終了]
[自分]
...
;----------------------------------シナリオ未完
[自分]
梶野、美園さんのことで話があるんだけど……[next]

[人物 画像= カケル  名前= 梶野カケル]
ミドリがどうかしたのか？[next]

[自分]
美園さんは梶野が他の女子達と一緒にいることを[n]
すごく不安に思っているみたいなんだ。[next]
...
[人物 画像= カケルはあ  名前= 梶野カケル]
オレ、[BGM 曲=空虚R.ogg ループ=false 音量=50]やっぱりミドリの彼氏でいる資格ないんだな。[next]
...
[人物 画像= カケルしゃべる  名前= 梶野カケル]
オレとしては、女子の方から近づいてくるし、[n]
ミドリがいない時間を埋められるからそれでいいか、[n]
と思ってたけど……[next]

ミドリのこと、不安にさせてたんだ。[next]
[表情 画像=カケルはあ]
彼女を不安にさせて、友達もいない[n]
オレなんて……[next]
[表情 画像=カケルめそらし]
...
[表情左 画像=ミドリうーん]
[表情右 画像= カケル]
[人物左 画像= ミドリうーん  名前= 美園ミドリ]
[ま][ま]……カケル君、話があるの。[next]

[人物右 画像= カケル  名前= 梶野カケル]
…………[next]
[人物左 画像=ミドリ苦笑 名前=美園ミドリ]
私ってカケル君に必要なのかな……？[next]
...
オレ、お前のこと不安にさせてたんだな。[next]

[人物左 画像= ミドリ黙る  名前= 美園ミドリ]
…………[next]

[人物右 画像= カケルしゃべる  名前= 梶野カケル]
オレの方がお前の彼氏に相応しくなかったよな。[next]

[人物左 画像= ミドリそれが  名前= 美園ミドリ]
そういうことが言いたいんじゃなくて……[next]
[表情左 画像=ミドリ悲しい]
...
[人物左 画像= ミドリ苦笑  名前= 美園ミドリ]
……私達、もう別れた方がいいのかな？[next]
[表情左 画像=ミドリ黙る]
[BGM停止 時間=4000]
[人物右 画像= カケル  名前= 梶野カケル]
…[ま]…[ま]…[ま]…[ま][ま][next]
[人物左 画像= ミドリじわぁ  名前= 美園ミドリ]
…[ま]…[ま]…[ま]…[ま][ま][next]
[人物右 画像=カケルしゃべる 名前=梶野カケル]
……そうだな。
もう、[BGM 曲=破局後.ogg 音量=60 ループ=false]終わりにしよう、オレ達。[next]

[人物左 画像= ミドリ病みじわぁ  名前= 美園ミドリ]
…………[next]

[人物右 画像= カケルめそらし  名前= 梶野カケル]
……[間][間][間][間]じゃあ、オレ、行くから。[next]
[人物右消去]
[人物左 画像=ミドリ病み笑い 名前=美園ミドリ]
…………[next]
カケル……くん……？[next]
...
[モノローグ]
俺が梶野と話をした日からだろうか……[n]
美園さんはあまり学校に来なくなってしまった。[next]

俺が聞いているのは[n]
あの二人がどうやら別れたらしいということだけだ。[next]
[人物全消去]
[モノローグ終了]
;----------------------------------
...
*遊園地に行こう
[足跡デバッグ 名前=遊園地に行こう]
[jump target="*遊園地に行こう2" cond="!足跡('カケルの友達')"]
...
*本文
;----------↓ここから↓----------シナリオ未完
[メッセージ]※シナリオ：遊園地に行こう[n]
マリ恋愛シナリオ４（カケル）＠しえさん 2015/12/18[next]
;----------↑ここまで↑----------
[足跡 名前=また新しく作っていけばいい]
...
[カケルなにしてる]
[if exp="種がある || f.カケル参加 || f.カケル不参加 || f.カケル招集"]
	[eval exp="var 強制招集 = ''"]
[else]
...
[jump target="*雑談昼参加後" cond="足跡('カケル参加')"]
[eval exp="sf.カケル雑談 = 0" cond="sf.カケル雑談 == void"]
[eval exp="sf.カケル雑談++"]
[jump target="*雑談昼Ａ" cond="sf.カケル雑談 % 1 == 0"]

*雑談昼Ａ
[モノローグ終了]
[自分]
なあ、梶野、次の教室ってどこだっけ？[next]
...
[人物左遠い 画像 = 女子生徒ア  名前 = 女子生徒]
梶野君、次の授業は化学室で実験だって。[n]
一緒に行こう？[next]
...
[人物 画像 = カケルななんだよ  名前 = 梶野カケル]
仕方ねえ……[if exp="足跡('カケルミドリ参加')"]小平[else]マリ[endif]に聞いてくる。[next]
...
[自分]
そういうわけじゃないんだけど……[n]
いつも誰かと一緒にいるイメージあるからさ。[next]

[人物 画像 = カケルしゃべる  名前 = 梶野カケル]
今日は予定があるから、もう帰るんだ。[next]

[表情 画像 = カケル]

[自分]
俺もちょうど帰るところだったんだ。[n]
せっかくだし、途中まで一緒に行こうよ？[next]
...
[自分]
予定って言ってたけど、何があるんだ？[next]

[人物 画像 = カケルしゃべる  名前 = 梶野カケル]
一人暮らししてる一番上の姉貴が[n]
久しぶりに帰ってくるから[n]
家族で食事に行くことになってる。[next]
...
[人物 画像 = カケルしゃべる  名前 = 梶野カケル]
姉が三人で、父親は単身赴任で普段家にいないから[n]
女ばっかりの中にオレ一人男でさ。[next]

[自分]
なんか大変そう……[next]

[人物 画像 = カケルめそらし  名前 = 梶野カケル]
よく言われるけど、実際そうでもないな。[next]

[表情 画像 = カケルにこ]
末っ子ってことなのか、多少のわがままは[n]
大目に見てもらえてる感じはするし。[n]

まあ、小さい時に姉貴たちがオレのことを[n]
着せ替え人形みたいにしてたのは大変だったけどな。[next]
