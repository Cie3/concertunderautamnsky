...
*マリは責任感が強い
[足跡デバッグ 名前=マリは責任感が強い]
[jump target="*マリは責任感が強い2" cond="!足跡('マリは責任感が強い') || 足跡('マリは実は頼りない？')"]
[カズキなにしてる]
...
[種入手 名前=マリは実は頼りない？ 詳細=マリはテニス部の中で評判が良くないとカズキが言っていた]
[足跡 名前=マリは実は頼りない？]
[モノローグ]
カズキが言った通り、[n]
...
*マリの秘密
[足跡デバッグ 名前=マリの秘密]
[jump target="*マリの秘密2" cond="!足跡('マリの秘密') || 足跡('前原先生はテニス部顧問')"]
[カズキなにしてる]
[種分岐 ア=マリの秘密 イ=何か他の話題は…… 体力=&シナリオ消費]
[if exp=イ][jump target="*マリの秘密2"][endif]
*本文
[モノローグ終了]
[自分]
...
*マリの恋心
[足跡デバッグ 名前=マリの恋心]
[jump target="*マリの恋心2" cond="!足跡('マリの恋心') || 足跡('マリ不参加')"]
[カズキなにしてる]
