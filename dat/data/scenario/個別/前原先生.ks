...
誰かの手を借りないと、絶対に間に合うわけないんだ。[next]

[自分]
なるほど、それで招集する必要があるわけですか。[next]
...
生命力を削って  100％ → 50％ にすると、[n]
回復量は最大でも 30％ → 25％ になってしまう。[next]
...
[人物 画像=前原先生目閉じ 名前=前原先生]
あのプラナリアの再生力が一体どこに由来しているのか[n]
現代の科学では解明されていない部分が多いんだ。[next]

あの、ゾッとする程の活力を秘めた液体に、[n]
何か不吉な代償が支払われていなければいいのだが……[next]
