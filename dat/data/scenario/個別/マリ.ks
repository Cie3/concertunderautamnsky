[足跡デバッグ 名前=マリ参加]
[jump target="*文化祭の買い出し" cond="f.平日準備中"]
[足跡デバッグ 名前=文化祭の買い出し終了]
[jump target="*カズキと一緒に出かけよう" cond="足跡('文化祭の買い出し終了') && !足跡('マリが付き合ったら行きたいところ')"]
...
*マリは部活で悩んでる？
[足跡デバッグ 名前=マリは部活で悩んでる？]
[jump target=*マリは部活で悩んでる？2 cond="!足跡('マリは部活で悩んでる？')"]
[jump target=*マリは部活で悩んでる？2 cond="足跡('マリのうまくいかない毎日')"]
[eval exp="種がある = 1" cond="findSeed('マリは部活で悩んでる？') >= 0"]
[マリなにしてる]
[種分岐 ア=マリは部活で悩んでる？ イ=何か他の話題は…… 体力=&シナリオ消費]
[if exp=イ][jump target="*マリは部活で悩んでる？2"][endif]
*マリは部活で悩んでる？-シナリオ
[モノローグ終了]
[自分]
...
　でもあたし、また中学の頃みたいになったら嫌だなぁって……』[next]
...
[人物消去]
[種入手 名前=マリのうまくいかない毎日 詳細=マリはカケルの勧めで部長になったけど、うまくいかない毎日みたいだ]
[足跡 名前=マリのうまくいかない毎日]
[return]
*マリは部活で悩んでる？2
...
[自分]
自分の気持ちが届かなくても[n]
そんな風に考えられるなんて、貫井さんって優しい人だなあ。[next]

[人物 画像= マリあちゃー  名前= 貫井マリ]
そ、そんなことないよ！[n]
[姓]って、本当に人を褒めるのが上手いなあ……[next]
[表情 画像=マリ]
じゃあ、あたし、そろそろ行くよ。[n]
...
[自分]
貫井さん、梶野と美園さんのこと……聞いた？[next]

[人物 画像 = マリ真面目  名前 = 貫井マリ]
ううん。[n]
美園さん、あんまり学校来なくなったから[n]
何かあったのかなって思って気になってはいるんだけど……[next]
...
あれから美園さんはあんまり学校に来ないし[n]
梶野も憂鬱そうにしていて声かけにくいんだよな。[next]

[足跡デバッグ 名前=マリが付き合ったら行きたいところ]
[if exp="足跡('マリが付き合ったら行きたいところ')"]
	[人物 画像=マリ悲しい 名前=貫井マリ]
	そっか……[next]
	[表情 画像=マリうーん]
	[自分]
	...
	いや、何でもないよ。[next]
	[表情 画像=マリえっ]
	あ、あたしちょっと用事あるから……[next]
	[モノローグ]
	そう言うと、貫井さんは行ってしまった。[next]
	[モノローグ終了]
	[足跡 名前=マリの未練]
	[return]
[endif]
...
[if exp="!足跡('カケルとマリの密会')"]
	...
	[表情 画像=マリ悲しい]
	[自分]
	今なら、貫井さんの気持ちを梶野に伝えてもいいと思うけど……[next]
	[人物 画像=マリはあ 名前=貫井マリ]
	うーん……それはしないかも。[next]
	[表情 画像=マリうーん]
	[自分]
	どうして？[next]
	[人物 画像=マリ真面目 名前=貫井マリ]
	テニス部のこと、どうしてもうまくいかなくて。[next]
	[表情 画像=マリ哀愁の笑み]
	心の中で梶野に[ルビ 読み=すが]縋ってただけだって、わかったんだ。[n]
	結局、何の解決にもならないのにね……[next]
	[表情 画像=マリあちゃー]
	なんだかんだ仕事は全然進まないし、[n]
	前原先生……怒ってるかなー[next]
	[自分]
	前原先生？ なんで？[next]
	[人物 画像=マリ 名前=貫井マリ]
	えっと、[ルビ 読み=じょ]女テニの顧問なんだ。[n]
	試合の時は見に来てくれるんだよ。[next]
	[表情 画像=マリうん]
	[自分]
	あ、そうなんだ。初めて知ったよ。[next]
	[人物 画像=マリあちゃー 名前=貫井マリ]
	ごめんね[姓]、なんか愚痴ばっかりもらしちゃって。[n]
	聞いてくれてありがとね……[next]
	[人物消去]
	[種入手 名前=前原先生はテニス部顧問 詳細=貫井さんのことで相談できるかもしれない]
	[足跡 名前=前原先生はテニス部顧問]
	[モノローグ]
	前原先生に相談したら何かわかるかもしれない。[n]
	文化祭の相談もしてみようかな。[next]
	[モノローグ終了]
	[return]
[endif]
...
友達がいないって悩んでたのに、[n]
彼女とも別れて苦しくないわけない。[n]
あたしが梶野の味方になるって伝えたいんだ。[next]

[表情 画像 = マリ決意]

[自分]
貫井さんの気持ち、きっと梶野に伝わるよ。[next]
...
[人物左 画像 = マリ真面目  名前 = 貫井マリ]
どうして……美園さんと別れたのか、聞いてもいい？[next]

[表情左 画像 = マリ決意]

[人物右 画像 = カケルしゃべる  名前 = 梶野カケル]
……オレがミドリを不安にさせてたのが悪かったんだ。[n]
あいつが悩んでいるのにも何も気が付かなくて。[next]

[表情右 画像 = カケルはあ 名前 = 梶野カケル]
友達もいなければ、彼女のことも大切にできない。[n]
やっぱりオレはお前が思ってるような人間じゃないんだよ。[next]

[表情右 画像 = カケル]

[人物左 画像 = マリ必死  名前 = 貫井マリ]
そんな自分がダメなやつみたいなこと言わないでよ……！！[next]

[人物右 画像 = カケルはあ  名前 = 梶野カケル]
でも……[next]

[人物左 画像 = マリ必死  名前 = 貫井マリ]
梶野が自分のことがどんなに嫌いになっても……[next]

[表情左 画像 = マリもう知らない 名前 = 貫井マリ]
あたしは梶野のこと、好きでいるから……！！[next]

[人物右 画像 = カケル驚き  名前 = 梶野カケル]
…………！！[next]
...
*マリが付き合ったら行きたいところ
[足跡デバッグ 名前=マリが付き合ったら行きたいところ]
[jump target=*マリが付き合ったら行きたいところ2 cond="f.マリデート != 0"]
[jump target=*マリが付き合ったら行きたいところ2 cond="!足跡('マリが付き合ったら行きたいところ')"]
[jump target=*マリが付き合ったら行きたいところ2 cond="足跡('遊園地に行こう')"]
[eval exp="種がある = 1" cond="findSeed('マリが付き合ったら行きたいところ') >= 0"]
[マリなにしてる]
[種分岐 ア=マリが付き合ったら行きたいところ イ=何か他の話題は…… 体力=&シナリオ消費]
[if exp=イ][jump target="*マリが付き合ったら行きたいところ2"][endif]
*本文
;----------↓ここから↓----------シナリオ未完
※シナリオ：マリが付き合ったら行きたいところ[n]
マリ恋愛シナリオ3＠らな　→3.5話に該当するシナリオ 2015/12/27[n]
デートの予定が入る[next]
;----------↑ここまで↑----------
[eval exp="f.マリデート = 2"]
...
[足跡デバッグ 名前=マリ参加]
[jump target="*雑談昼参加後" cond="足跡('マリ参加')"]
[eval exp="sf.マリ雑談 = 0" cond="sf.マリ雑談 == void"]
[eval exp="sf.マリ雑談++"]
[jump target="*雑談昼Ａ" cond="sf.マリ雑談 % 1 == 0"]
...
[自分]
どうしたの、貫井さん、浮かない顔して？[next]

[人物 画像= マリ真面目  名前= 貫井マリ]
あっ、[姓]……[next]

[表情 画像= マリあちゃー  名前= 貫井マリ]
...
[自分]
俺は文化祭のことで職員室に用事があるんだ。[next]

[人物 画像= マリ真面目  名前= 貫井マリ]
そうなんだ……[n]
あんまり準備に参加できなくてごめんね。[next]

[表情 画像= マリうーん  名前= 貫井マリ]

[自分]
貫井さんこそ、テニス部忙しいんだよね？[n]
文化祭のこと、気にしてくれるだけで嬉しいよ。[next]
...
[人物 画像= マリ  名前= 貫井マリ]
ありがとう、でも今度は自分で頑張ってみたいんだ。[n]
だから気持ちだけ受け取っておくね。[next]
...
[自分]
えっ！？[n]
そんなに前からなんだ、だから上手なんだね。[next]

[人物 画像= マリ  名前= 貫井マリ]
でも、その前は女子サッカーとかソフトボールとか[n]
他のスポーツもやってたんだ。[next]

テニスが一番面白い、って思ってから他のスポーツは[n]
全部やめちゃったんだけど……[next]

[表情 画像= マリあはは  名前= 貫井マリ]
サッカーの試合がテレビで放送されてると[n]
今でもつい見ちゃうんだよね。[next]

[表情 画像= マリうん  名前= 貫井マリ]

[自分]
俺も昔、サッカーやってたからその気持ちわかるよ。[n]
「そこでシュート！」とかテレビに向かって[n]
叫んじゃったりして……[next]
...
[枠]
;----------↓ここから↓----------シナリオ未完
[メッセージ]※シナリオ：文化祭の買い出し行く前[n]
マリ恋愛シナリオ１＠らな 2015/12/07[next]
;----------↑ここまで↑----------
[場面転換]
[背景 画像=文具店]
[枠]
...
[メッセージ]
※シナリオ：カズキと一緒に出掛けよう[n]
マリ恋愛シナリオ2＠らな 2015/12/07[next]
;----------↑ここまで↑----------
[種入手 名前=マリが付き合ったら行きたいところ 詳細=それって恋人とじゃなくても行けるのでは？]
[足跡 名前=マリが付き合ったら行きたいところ]
[eval exp="f.マリデート = 1"]
[return]
...
;----------↓ここから↓----------シナリオ未完
[メッセージ]
※シナリオ：マリ恋愛シナリオ３（マリデート１）[n]
マリ恋愛シナリオ3＠らな　→３話に該当するシナリオ 2015/12/27[next]
;----------↑ここまで↑----------
[足跡 名前=マリデート１終了]
[実績解除 名前=実績１１：デート！？]
[eval exp="f.マリデート = 0"]
...
[if exp=ア]
	...
	;----------↑ここまで↑----------
	[eval exp="f.マリ攻略 = 1"]
	[eval exp="f.マリ加速++, f.主人公加速++"]
	[足跡 名前=マリ攻略]
[else]
	;----------↓ここから↓----------シナリオ未完
	※マリとケンカ別れ[next]
	※警告：シナリオが執筆されていない[next]
	;----------↑ここまで↑----------
	[eval exp="f.マリけんか = 1"]
	[足跡 名前=マリけんか]
	[実績解除 名前=実績１７：仲たがい]
	[eval exp="f.マリ恋愛栄養ドリンク = 1"]
[endif]
[return]
