...
[eval exp="sf.マユ雑談 = 0" cond="sf.マユ雑談 == void"]
[足跡デバッグ 名前=マユ参加]
[jump target="*雑談昼参加後" cond="足跡('マユ参加')"]
[eval exp="sf.マユ雑談++"]
[jump target="*雑談昼Ａ" cond="sf.マユ雑談 % 2 == 0"]
[jump target="*雑談昼Ｂ" cond="sf.マユ雑談 % 2 == 1"]
...
えへへ。[n]
ボク、頑張って[n]
とびっきり可愛いのにするからね！[next]
[return cond=!testplay]
*雑談夕方
[モノローグ終了]
[自分]
桜さんって、コスプレするんだよね。[n]
やっぱりアニメとかゲームとか詳しいの？[next]
...
[人物 画像=マユしゃべる 名前=桜マユ]
うーん、魔法少女モノとか可愛いよね。[n]
『くーも☆ＤＯＮ！』とか好きだよー。[next]

[自分]
……俺はあまり見ないんだけど、面白いの？[next]

[人物 画像=マユ笑顔 名前=桜マユ]
うん、出てくる子がみんな可愛いんだー。[next]
