...
[種入手    名前=カケルは寂しい人    詳細=ミドリはカケルのことを「寂しい人」だと言った  期限=10]
[足跡 名前=カケルは寂しい人]
...
*カケルの友達
[足跡デバッグ 名前=カケルの友達]
[jump target="*カケルの友達2" cond="!足跡('カケルの友達') || 足跡('ミドリを選んだ理由')"]
...
[モノローグ]
[種入手    名前=ミドリを選んだ理由 詳細=どうしてカケルはミドリを選んだのか、ミドリは知らない]
[足跡 名前=ミドリを選んだ理由]
...
;----------------------------------シナリオ未完
[自分]
あの、美園さん、梶野のことなんだけど……[next]

[人物 画像=ミドリうーん   名前= 美園ミドリ]
うん……[next]

[自分]
俺も他の人にも話を聞いたりしたんだけど。[n]

梶野は梶野でうまくやってるんじゃないかな？[next]

[人物 画像= ミドリぎくっ  名前= 美園ミドリ]
えっ？[next]

[自分]
ほら、梶野は寂しい人だから、美園さんが一緒にいないと[n]
いけないって言ってたけどさ。[n]
確かに男子の友達はいないけど、女子の友達はいるわけだし。[next]

[人物 画像= ミドリ悲しい  名前= 美園ミドリ]
女子の……友達……[next]

[BGM停止 時間=3000]
[自分]
うん、だから美園さんがそこまで心配することもないんじゃ……[next]

[人物 画像= ミドリそれが  名前= 美園ミドリ]
やっぱり……私なんて要らないんだ……[next]
...
[人物 画像= ミドリはあ  名前= 美園ミドリ]
私、本当はずっと不安だったの。[n]
カケル君はかっこよさ目当ての女の子たちのこと[n]
別に嫌いじゃないのかもって……[next]
[表情 画像=ミドリ苦笑]
だけど、私だけがカケル君の寂しさに気が付いてる。[n]
だから私はカケル君にとって特別なんだって[n]
思って不安をごまかしていたの。[next]
[BGM 曲=空虚R.ogg ループ=false 音量=50]
[表情 画像=ミドリはあ]
でも……やっぱりそうだったんだね。[n]
カケル君は私なんていなくても……[next]
[表情 画像=ミドリ悲しい]
...
[モノローグ]
美園さんは酷く落ち込んでいるようだ。[n]
俺にはかける言葉が見つからない。[next]
[モノローグ終了]

[人物 画像= ミドリそれが  名前= 美園ミドリ]
あっ……ごめんね、こんな話しちゃって……[next]
[表情 画像=ミドリじわぁ]
[自分]
いや、俺は別に……[next]

[人物 画像= ミドリ病みじわぁ  名前= 美園ミドリ]
私、もう行くから……[n]
またね、[姓]くん。[next]

[自分]
あっ、ちょっと待って、美園さん！[next]

[人物消去]

[種入手 名前=絶望するミドリ 詳細=ミドリはカケルが女遊びをしていると知ってショックを受けたようだ]

美園さん、凄く傷ついた顔をしていたな……[n]
このままだとまずい気がする。[next]

このことを梶野に伝えて、美園さんの不安を取り除いてもらおう。[next]
...
[モノローグ終了]
;----------------------------------シナリオ未完
[メッセージ]※シナリオ：カケルとマリの密会[n]
カケル・ミドリBADルート表情差分適用等＠せふぇい[next]
;----------------------------------
...
[ミドリなにしてる]
[if exp="種がある || f.ミドリ参加 || f.ミドリ不参加 || f.ミドリ招集"]
	[eval exp="var 強制招集 = ''"]
[else]
...
[jump target="*雑談昼参加後" cond="足跡('ミドリ参加')"]
[eval exp="sf.ミドリ雑談 = 0" cond="sf.ミドリ雑談 == void"]
[eval exp="sf.ミドリ雑談++"]
[jump target="*雑談昼Ａ" cond="sf.ミドリ雑談 % 1 == 0"]

*雑談昼Ａ
[モノローグ終了]
[自分]
美園さんっていつもケータイ弄ってるけど[n]
何を見てるの？[next]
...
[自分]
あ、ごめん、言いたくなかったらいいんだけど。[next]

[人物 画像 = ミドリ苦笑  名前 = 美園ミドリ]
……占いサイトを見てることが多いかな。[next]
[表情 画像 = ミドリうーん  名前 = 美園ミドリ]

[自分]
へえ、そうなんだ。[next]

[人物 画像 = ミドリ苦笑  名前 = 美園ミドリ]
うん、恋愛系の占いは結構気になっちゃうの。[next]
[表情 画像 = ミドリうーん  名前 = 美園ミドリ]

[自分]
(女子って占い好きなイメージあるけど本当なんだな)[next]

[人物 画像 = ミドリ苦笑  名前 = 美園ミドリ]
じゃあ、私、カケル君のところに行くから……[next]
[表情 画像 = ミドリ  名前 = 美園ミドリ]
...
[モノローグ]
俺は美園さんに自分の誕生日と血液型を教えた。[next]
[モノローグ終了]

[人物 画像 = ミドリしゃべる  名前 = 美園ミドリ]
「多くの異性を引き付ける博愛主義者。[n]
全ての人を思いやるため、恋愛においては[n]
優柔不断な人と思われがちかも？」[next]

[表情 画像 = ミドリしゃべる  名前 = 美園ミドリ]
だって、[姓]くん。[next]

[表情 画像 = ミドリ断言  名前 = 美園ミドリ]
ちゃんと好きな人は一人に絞らないとダメだよ？[next]
[表情 画像 = ミドリ決意  名前 = 美園ミドリ]
...
[人物 画像 = ミドリ苦笑  名前 = 美園ミドリ]
塾まで時間があるから少し待っていたんだけど……[n]
そろそろ行こうかな。[next]

[表情 画像 = ミドリうーん  名前 = 美園ミドリ]

[自分]
じゃあ、途中まで一緒に帰ってもいい？[next]
...
[自分]
高校２年生の今から塾に通ってるなんて[n]
美園さんって真面目なんだね。[next]

[人物 画像 = ミドリそれが  名前 = 美園ミドリ]
えっ……そんなことないよ……[n]
それしか頑張ってることないから……[next]

[表情 画像 = ミドリうーん  名前 = 美園ミドリ]

[自分]
１年生の頃はよく成績優秀者のところに[n]
名前があった気がするんだけど。[next]

[人物 画像 = ミドリ苦笑  名前 = 美園ミドリ]
あのころはカレンと一緒に二人で勉強してたから[n]
頑張れたんだと思う。[n]
楽しかったな……[next]
...
[jump target="*雑談夕方参加後" cond="足跡('ミドリ参加')"]

[人物 画像 = ミドリはあ  名前 = 美園ミドリ]
私に対してカレンはきっと怒ってるから……[n]
でも、本当はもう一度仲良くなりたいなって思ってて。[next]

[表情 画像 = ミドリうーん  名前 = 美園ミドリ]

[自分]
大丈夫、必ず仲直りできるよ。[n]
事情もよく知らないし、根拠もないけど[n]
そんな気がする。[next]
...
[人物 画像 = ミドリしゃべる  名前 = 美園ミドリ]
久しぶりだからちょっとドキドキしてるけど……[n]
でも、[姓]くんのおかげだね、ありがとう。[next]
[表情 画像 = ミドリ  名前 = 美園ミドリ]
