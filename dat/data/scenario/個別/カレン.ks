...
私、ミドリ[悲しみ.ogg]が本格喫茶という案を出してくれて嬉しかったの。[n]
...
書類を出そうとしたときに、[n]
何かペラリと一枚の写真が飛び出して、[n]
恋ヶ窪さんの[ぺらり.ogg]足元にすべりこんだ。[next]
[表情 画像=カレンねえ]
[BGM停止]ん？[ま] まさか……[n]
アレは、[ま]桜さんの……[next]
コスプレ[ガーン.ogg]写真！[next]
[モノローグ終了]
...
[eval exp="sf.カレン雑談 = 0" cond="sf.カレン雑談 == void"]
[eval exp="sf.カレン雑談++"]
[jump target="*雑談昼Ａ" cond="sf.カレン雑談 % 1 == 0"]
...
[人物 画像= カレンしゃべる  名前= 恋ヶ窪カレン]
次の授業のノートを確認しているだけよ。[next]

[表情 画像= カレン  名前= 恋ヶ窪カレン]

[自分]
す、すごいな……[n]
俺なんて授業が始まってからしかノート見ないよ。[next]

[人物 画像= カレンねえ  名前= 恋ヶ窪カレン]
まあ、中学生のころからの習慣ではあるけれど……[next]

[表情 画像= カレンしゃべる  名前= 恋ヶ窪カレン]

ほら、クラス実行委員が補習になったらいけないでしょう？[next]
...
いつも任せてばっかりでごめんね。[next]

[人物 画像= カレンしゃべる  名前= 恋ヶ窪カレン]
いいのよ、私の方が事務的な作業は得意だから。[n]
それに今日はもう終わったところなの。[n]
一緒に帰りましょう？[next]
...
[自分]
文化祭までもうあまり時間がないなあ……[next]

[人物 画像= カレン発言  名前= 恋ヶ窪カレン]
そうね、私達クラス実行委員ももっと頑張らないといけないわね。[next]
...
[人物 画像= カレンにこ  名前= 恋ヶ窪カレン]
うふふ、やっぱり[姓]君がクラス実行委員で良かったわ。[next]

[自分]
えっ？[next]

[人物 画像= カレンにこ  名前= 恋ヶ窪カレン]
[姓]君みたいに真面目な人と一緒に仕事をしていると[n]
楽しいし、やりがいも感じられるもの。[next]

[自分]
恋ヶ窪さん……[next]

[人物 画像= カレンしゃべる  名前= 恋ヶ窪カレン]
じゃあ、私こっちだから、また明日ね。[next]
...
借りたノートを適当に[ぺらり.ogg]ペラペラとめくった。[next]
[人物消去]
[背景 画像=恋ヶ窪ノート]
[モノローグ終了]
[メッセージ]
...
[表情 画像=カレン]
[自分]
恋ヶ窪さんはどこ[カラス.ogg]までバスに乗るの？[next]
