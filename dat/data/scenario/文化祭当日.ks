...
[macro name=スコア表示]
進捗率：[font color=&色：強化 cond="highscore1"][emb exp="f.進捗"]％[resetfont]
　成績累計：[font color=&色：強化 cond="highscore2"][emb exp="f.試験の累計点数"][resetfont]点
　[font color=色：強化][emb exp="'☆HIGHSCORE☆'" cond="highscore1 + highscore2"][resetfont]
[endmacro]
...
[if exp="testplay"]
	...
	[四択 ア=なし イ=カケル参加 ウ=ミドリ参加 エ=両方参加]
	[if exp="ア"]
	[elsif exp="イ"]
		[eval exp="f.カケル参加 = 1"]
	[elsif exp="ウ"]
...
[if exp="f.ミドリ参加"]……まあ、お前から頼まれたからにはな。[n]
[else]……まあ、実行委員のお前の頼みだしな。[n]
[endif]
最後まで頑張るよ。[next]
[表情 画像=カケルふっ]
...
*発表失敗
三位……[ま][ま][n]
[SE buf=0 音=シンバル 音量=50]３年１組 焼きそば屋台[SE buf=2 音=拍手短い 音量=80][SE buf=1 音=歓声 音量=50] 「バーニング☆ヌードル！」[fadese buf=1 time=1000][ま][ま][ま][ま][ま][next]
[SE停止 buf=1]
二位……[ま][ま][n]
[SE buf=0 音=シンバル 音量=50]３年４組 お化け屋敷[SE buf=2 音=拍手短い 音量=80] 「恐怖の廃病院」[fadese buf=1 time=1000][ま][ま][ま][ま][ま][next]
[SE停止 buf=1]
[SE buf=2 音=ドラムロール 音量=100]そして一位は……[ま][ま][ま][next]

[fadese buf=2 time=500]
[ま][ま][ま]
[SE buf=1 音=シンバル 音量=100]
３年３組 数字占い[SE buf=2 音=歓声 音量=100] 「タカＴ大御殿」！！[SE buf=0 音=拍手長い 音量=100][ま][ま][ま][ま][ま][next]
...
*発表成功
三位……[ま][ま][n]
[SE buf=0 音=シンバル 音量=50]３年４組 お化け屋敷[SE buf=2 音=拍手短い 音量=80][SE buf=1 音=歓声 音量=50] 「恐怖の廃病院」[fadese buf=1 time=1000][ま][ま][ま][ま][ま][next]
[SE停止 buf=1]
二位……[ま][ま][n]
[SE buf=0 音=シンバル 音量=50]３年３組 数学占い[SE buf=2 音=拍手短い 音量=80] 「タカＴ大御殿」[fadese buf=1 time=1000][ま][ま][ま][ま][ま][next]
[SE停止 buf=1]
[SE buf=2 音=ドラムロール 音量=100]そして一位は……[ま][ま][ま][next]
...
[ま][ま][ま]
[SE buf=1 音=シンバル 音量=100]
２年２組 本格喫茶[SE buf=2 音=歓声 音量=100] 「カフェ・コンチェルト」！！[SE buf=0 音=拍手長い 音量=100][ま][ま][ま][ま][ま][next]
